...
for($i = 0;$i < $anz;$i++)
{
	if($afile[$i] != "." && $afile[$i] != ".." && $afile[$i] != ".htaccess")
	{
		...
		echo "<div id='pdf'><a href='download.php?datei=".$afile[$i]."&typ=pdf&pfad=".$_user->_ordnerpfad."'><img id='zip' src='images/ico/pdf.png' border=0 width=86><br><font size=-4>$afile[$i]</font></a>";
