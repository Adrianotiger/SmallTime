...
echo   "<td align=left class=td_background_tag >".$_users->_array[$x]['pfad']."</td>";
echo   "</tr>";
echo   "<tr>";
echo   "<td align=left class=td_background_tag>Loginname</td>";
echo   "<td align=left class=td_background_tag >".$_users->_array[$x]['name']."</td>";
echo   "</tr>";
echo   "<tr>";
echo   "<td align=left class=td_background_tag>Passwort</td>";
echo   "<td align=left class=td_background_tag >".$_users->_array[$x]['passwort']."</td>";
echo   "</tr>";
echo   "<tr>";
echo   "<tr>";
echo   "<td align=left class=td_background_tag>RFID</td>";
echo   "<td align=left class=td_background_tag >".$_users->_array[$x]['rfid']."</td>";
echo   "</tr>";
echo   "<tr>";
